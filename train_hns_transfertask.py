    ...
    for episode in range(episodes):
        ...
        for step in range(args.episode_length):
            ...
            rollouts.insert(share_obs, 
                            ...
                            rewards, 
                            masks)
        print('success_rate: ', np.mean(step_cover_rate[:,-1]))
        logger.add_scalars('agent/traing_success_rate',{'training_success_rate': np.mean(step_cover_rate[:,-1])}, (episode+1) * args.episode_length * args.n_rollout_threads)
